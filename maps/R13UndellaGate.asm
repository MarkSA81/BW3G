...
Rt13UndellaGate_MapEvents:
	...
	db 4 ; warp events
	warp_event  3,  3, R_13, 2
	warp_event  4,  3, R_13, 3
	warp_event  3, 14, UNDELLA_TOWN, 1
	warp_event  4, 14, UNDELLA_TOWN, 1
	...
	db 2 ; object events
	object_event  5,  8, SPRITE_SOCIALITE, SPRITEMOVEDATA_WALK_UP_DOWN, 0, 1, -1, -1, PAL_NPC_BROWN, OBJECTTYPE_SCRIPT, 0, Rt13UndellaGateSocialiteScript, -1
	object_event  1,  6, SPRITE_FISHER, SPRITEMOVEDATA_SPINRANDOM_SLOW, 0, 0, -1, -1, PAL_NPC_GREEN, OBJECTTYPE_SCRIPT, 0, Rt13UndellaGateFisherScript, -1
