	...
	const MOOROFICIRRUS_MAX_ELIXIR
...
MoorOfIcirrus_MapEvents:
	...
	object_event 30,  4, SPRITE_POKE_BALL, SPRITEMOVEDATA_STILL, 0, 0, -1, -1, 0, OBJECTTYPE_ITEMBALL, 0, MoorOfIcirrusMaxElixir, EVENT_MOOR_OF_ICIRRUS_MAX_ELIXIR
	...
	object_event  9, 27, SPRITE_RANGER_F, SPRITEMOVEDATA_STANDING_LEFT, 0, 0, -1, -1, PAL_NPC_RED_D, OBJECTTYPE_TRAINER, 2, TrainerPkmnRangerFMoorOfIcirrus, -1
	object_event 18, 26, SPRITE_RANGER_M, SPRITEMOVEDATA_SPINRANDOM_FAST, 0, 0, -1, -1, PAL_NPC_RED, OBJECTTYPE_TRAINER, 3, TrainerPkmnRangerMMoorOfIcirrus, -1
