...
SkyarrowBridge_MapEvents:
	...
	db 4 ; warp events
	warp_event  4,  4, CASTELIA_BRIDGE_GATE, 3
	warp_event  4,  5, CASTELIA_BRIDGE_GATE, 4
	warp_event 45,  4, PINWHEEL_BRIDGE_GATE, 3
	warp_event 45,  5, PINWHEEL_BRIDGE_GATE, 4
