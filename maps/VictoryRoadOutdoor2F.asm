	...
	const VICTORYROADOUTDOOR2F_MAX_ELIXIR
...
VictoryRoadOutdoor2F_MapEvents:
	...
	object_event 28, 19, SPRITE_POKE_BALL, SPRITEMOVEDATA_STILL, 0, 0, -1, -1, 0, OBJECTTYPE_ITEMBALL, 0, VictoryRoadOutdoor2FMaxElixir, EVENT_VICTORY_ROAD_EXT_MAX_ELIXIR_2
