...
; - scripts and events (see data/maps/scripts.asm)
	...
	map_const VICTORY_ROAD_CASTLE_OUTSIDE, 12, 10
	...
	newgroup
	map_const NACRENE_OUTSKIRT, 10, 26
	...
	map_const ICIRRUS_CITY_SOUTH_CONNECTION_DUMMY, 26, 3
	...
	map_const VICTORY_ROAD_POKECENTER_1F, 5, 6
	map_const PKMN_LEAGUE_POKECENTER_1F, 5, 6
