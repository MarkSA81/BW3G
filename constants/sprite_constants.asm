...
; OverworldSprites indexes (see data/sprites/sprites.asm)
	...
	const SPRITE_HILBERT ; 79
	const SPRITE_HILDA ; 7a
...
SPRITE_VARS EQU const_value
	...
	const SPRITE_VIRBANK_GRUNT_1 ; f6
	const SPRITE_VIRBANK_GRUNT_2 ; f7
	const SPRITE_VIRBANK_GRUNT_3 ; f8
	const SPRITE_NIMBASA_PARK_BATTLE ; f9
	const SPRITE_NUVEMA_TOWN_BATTLE ; fa
	const SPRITE_MEMBERS_ROOM_BLUE ; fb
	const SPRITE_MEMBERS_ROOM_BROWN ; fc
	const SPRITE_VIO ; fd
