...
MapGroup_Pwt:
	...
	map PWTQualifierRoom, TILESET_BATTLE_TOWER, INDOOR, POKEMON_WORLD_TOURNAMENT, MUSIC_BATTLE_TOWER_THEME, TRUE, PALETTE_DAY, FISHGROUP_SHORE
	...
	map PWTBattleRoom, TILESET_BATTLE_TOWER, INDOOR, POKEMON_WORLD_TOURNAMENT, MUSIC_BATTLE_TOWER_THEME, TRUE, PALETTE_DAY, FISHGROUP_SHORE
