...
MapGroup_Dungeons:
	...
	map RelicCastle1F, TILESET_DESERT, CAVE, RELIC_CASTLE, MUSIC_DESERT_RESORT, TRUE, PALETTE_AUTO, FISHGROUP_SHORE
	map RelicCastleB1F, TILESET_DESERT, CAVE, RELIC_CASTLE, MUSIC_DESERT_RESORT, TRUE, PALETTE_AUTO, FISHGROUP_SHORE
	map RelicCastleB2F, TILESET_DESERT, CAVE, RELIC_CASTLE, MUSIC_DESERT_RESORT, TRUE, PALETTE_AUTO, FISHGROUP_SHORE
	map RelicCastleB3F, TILESET_DESERT, CAVE, RELIC_CASTLE, MUSIC_DESERT_RESORT, TRUE, PALETTE_AUTO, FISHGROUP_SHORE
	map RelicCastleB4F, TILESET_DESERT, CAVE, RELIC_CASTLE, MUSIC_DESERT_RESORT, TRUE, PALETTE_AUTO, FISHGROUP_SHORE
	map NimbasaParkCoasterRoom, TILESET_GAME_CORNER, DUNGEON, NIMBASA_PARK, MUSIC_SEWERS, TRUE, PALETTE_NITE, FISHGROUP_SHORE
	map NimbasaParkRunway, TILESET_GAME_CORNER, DUNGEON, NIMBASA_PARK, MUSIC_SEWERS, TRUE, PALETTE_NITE, FISHGROUP_SHORE
	map NimbasaParkBasement, TILESET_FACILITY, DUNGEON, NIMBASA_PARK, MUSIC_SEWERS, TRUE, PALETTE_NITE, FISHGROUP_SHORE
	...
	map TwistMountainEntrance, TILESET_CAVE, CAVE, TWIST_MOUNTAIN, MUSIC_VICTORY_ROAD, TRUE, PALETTE_NITE, FISHGROUP_SHORE
	...
	map NsRoom, TILESET_CHAMPIONS_ROOM, CAVE, VICTORY_ROAD, MUSIC_VICTORY_ROAD, FALSE, PALETTE_NITE, FISHGROUP_SHORE
	map TwistMountain1F, TILESET_CAVE, CAVE, TWIST_MOUNTAIN, MUSIC_VICTORY_ROAD, TRUE, PALETTE_NITE, FISHGROUP_SHORE
	map TwistMountain2F, TILESET_CAVE, CAVE, TWIST_MOUNTAIN, MUSIC_VICTORY_ROAD, TRUE, PALETTE_NITE, FISHGROUP_SHORE
	map TwistMountain3F, TILESET_CAVE, CAVE, TWIST_MOUNTAIN, MUSIC_VICTORY_ROAD, TRUE, PALETTE_NITE, FISHGROUP_SHORE
	map TwistMountainOutside, TILESET_CAVE_RUINS, ROUTE, TWIST_MOUNTAIN, MUSIC_VICTORY_ROAD, TRUE, PALETTE_AUTO, FISHGROUP_SHORE
	map TwistMountainHouse, TILESET_HOUSE, INDOOR, TWIST_MOUNTAIN, MUSIC_VICTORY_ROAD, TRUE, PALETTE_DAY, FISHGROUP_SHORE
	map TwistMountainB1F, TILESET_CAVE, CAVE, TWIST_MOUNTAIN, MUSIC_VICTORY_ROAD, TRUE, PALETTE_NITE, FISHGROUP_SHORE
	map TwistMountainGenesectRoom, TILESET_CAVE, CAVE, TWIST_MOUNTAIN, MUSIC_VICTORY_ROAD, TRUE, PALETTE_NITE, FISHGROUP_SHORE
...
MapGroup_Humilau:
	...
	map Rt21, TILESET_UNOVA_BEACH, ROUTE, R_21, MUSIC_R_17, FALSE, PALETTE_AUTO, FISHGROUP_OCEAN
...
MapGroup_Lentimas:
	...
	map LentimasCoinHouse, TILESET_TRADITIONAL_HOUSE, INDOOR, LENTIMAS_TOWN, MUSIC_LENTIMAS_TOWN, FALSE, PALETTE_DAY, FISHGROUP_SHORE
...
MapGroup_Castelia:
	...
	map BattleCompany1F, TILESET_RADIO_TOWER, INDOOR, CASTELIA_CITY, MUSIC_CASTELIA_CITY, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map BattleCompany2F, TILESET_RADIO_TOWER, INDOOR, CASTELIA_CITY, MUSIC_CASTELIA_CITY, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	...
	map CasteliaTradeHouse1, TILESET_MANSION, INDOOR, CASTELIA_CITY, MUSIC_CASTELIA_CITY, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map CasteliaTradeHouse2, TILESET_MANSION, INDOOR, CASTELIA_CITY, MUSIC_CASTELIA_CITY, FALSE, PALETTE_DAY, FISHGROUP_SHORE
...
MapGroup_Floccesy:
	...
	map AldersHouse, TILESET_TRADITIONAL_HOUSE, INDOOR, FLOCCESY_TOWN, MUSIC_FLOCCESY_TOWN, FALSE, PALETTE_DAY, FISHGROUP_SHORE
...
MapGroup_Striaton:
	...
	map Rt3DayCare, TILESET_HOUSE, INDOOR, R_3, MUSIC_R_3, FALSE, PALETTE_DAY, FISHGROUP_SHORE
...
MapGroup_Pwt:
	map PWTOutside, TILESET_BATTLE_TOWER_OUTSIDE, TOWN, POKEMON_WORLD_TOURNAMENT, MUSIC_BATTLE_TOWER_THEME, FALSE, PALETTE_AUTO, FISHGROUP_SHORE
	map PWTInside, TILESET_BATTLE_TOWER, INDOOR, POKEMON_WORLD_TOURNAMENT, MUSIC_BATTLE_TOWER_LOBBY, TRUE, PALETTE_DAY, FISHGROUP_SHORE
	map PWTHallway, TILESET_BATTLE_TOWER, INDOOR, POKEMON_WORLD_TOURNAMENT, MUSIC_BATTLE_TOWER_LOBBY, TRUE, PALETTE_DAY, FISHGROUP_SHORE
	map PWTQualifierRoom, TILESET_BATTLE_TOWER, INDOOR, POKEMON_WORLD_TOURNAMENT, MUSIC_BATTLE_TOWER_LOBBY, TRUE, PALETTE_DAY, FISHGROUP_SHORE
	map PWTBackRoom, TILESET_BATTLE_TOWER, INDOOR, POKEMON_WORLD_TOURNAMENT, MUSIC_BATTLE_TOWER_LOBBY, TRUE, PALETTE_DAY, FISHGROUP_SHORE
	map PWTBattleRoom, TILESET_BATTLE_TOWER, INDOOR, POKEMON_WORLD_TOURNAMENT, MUSIC_BATTLE_TOWER_LOBBY, TRUE, PALETTE_DAY, FISHGROUP_SHORE
...
MapGroup_Opelucid:
	...
	map MembersRoom, TILESET_AIRPORT, INDOOR, R_9, MUSIC_MART, FALSE, PALETTE_DAY, FISHGROUP_SHORE
...
MapGroup_Icirrus:
	map TubelineBridge, TILESET_AIRPORT, INDOOR, TUBELINE_BRIDGE, MUSIC_SKYARROW, FALSE, PALETTE_AUTO, FISHGROUP_SHORE
...
MapGroup_PkmnLeague:
	...
	map GrimsleysRoom, TILESET_ELITE_FOUR_ROOM_2, INDOOR, POKEMON_LEAGUE, MUSIC_PKMN_LEAGUE, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map MarshalsRoom, TILESET_ELITE_FOUR_ROOM, INDOOR, POKEMON_LEAGUE, MUSIC_PKMN_LEAGUE, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map ElesasRoom, TILESET_ELITE_FOUR_ROOM_2, INDOOR, POKEMON_LEAGUE, MUSIC_PKMN_LEAGUE, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map ColresssRoom, TILESET_ELITE_FOUR_ROOM, INDOOR, POKEMON_LEAGUE, MUSIC_PKMN_LEAGUE, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map ChampionsRoomEntrance, TILESET_PKMN_LEAGUE, INDOOR, POKEMON_LEAGUE, MUSIC_PKMN_LEAGUE, FALSE, PALETTE_AUTO, FISHGROUP_SHORE
	map ChampionsRoom, TILESET_CHAMPIONS_ROOM, INDOOR, POKEMON_LEAGUE, MUSIC_NONE, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map HallOfFame, TILESET_CHAMPIONS_ROOM, INDOOR, POKEMON_LEAGUE, MUSIC_NUVEMA_TOWN, FALSE, PALETTE_DAY, FISHGROUP_SHORE
