...
; entries correspond to constants/move_constants.asm
	...
	move HORN_LEECH,   EFFECT_LEECH_HIT,          75, GRASS, PHYSICAL,    100, 10,   0
	...
	move LEAF_STORM,   EFFECT_OVERHEAT,          130, GRASS, SPECIAL,      90,  5,   0
	move GROWTH,       EFFECT_GROWTH,              0, GRASS, STATUS,        0, 20,   0
	...
	move WAVE_CRASH,   EFFECT_RECOIL_HIT,        120, WATER, PHYSICAL,    100, 15,   0
	...
	move ICICLE_SPEAR, EFFECT_MULTI_HIT,          25, ICE, PHYSICAL,      100, 30,  30
...
4   move LEECH_LIFE,   EFFECT_LEECH_HIT,          20, BUG, PHYSICAL,      100, 15,   0
	...
	move LOW_SWEEP,    EFFECT_SPEED_DOWN_HI       65, FIGHTING, PHYSICAL, 100, 20, 100
	move DRAIN_PUNCH,  EFFECT_LEECH_HIT,          75, FIGHTING, PHYSICAL, 100, 10,   0
	move SACRED_SWORD, EFFECT_NORMAL_HIT,         90, FIGHTING, PHYSICAL, 100, 15,   0
	...
	move VACCUM_WAVE,  EFFECT_PRIORITY_HIT,       40, FIGHTING, SPECIAL,  100, 30,   0
	...
	move ROOST,        EFFECT_HEAL,                0, FLYING, STATUS,     100, 20,   0
	...
	move ROCK_BLAST,   EFFECT_MULTI_HIT,          25, ROCK, PHYSICAL,      90, 25,   0
	...
	move PHANTOM_FORCE, EFFECT_FLY,               90, GHOST, PHYSICAL,    100, 10,   0
	...
	move SNARL,        EFFECT_SP_ATK_DOWN_HIT,    55, DARK, SPECIAL,      100, 25, 100
	...
	move DISARM_VOICE, EFFECT_ALWAYS_HIT,         40, FAIRY, SPECIAL,     100, 15,   0
...
1	move TAIL_SLAP,    EFFECT_MULTI_HIT,          25, NORMAL, PHYSICAL,    85, 10,   0
1	move FALSE_SWIPE,  EFFECT_FALSE_SWIPE,        40, NORMAL, PHYSICAL,   100, 40,   0
1	move TACKLE,       EFFECT_NORMAL_HIT,         40, NORMAL, PHYSICAL,   100, 35,   0
1	move TAKE_DOWN,    EFFECT_RECOIL_HIT,         90, NORMAL, PHYSICAL,    85, 20,   0
1	move DOUBLE_EDGE,  EFFECT_RECOIL_HIT,        120, NORMAL, PHYSICAL,   100, 15,   0
1	move TRASH,        EFFECT_RAMPAGE,           120, NORMAL, PHYSICAL,   100, 10,   0
1	move BODY_SLAM,    EFFECT_PARALYZE_HIT,       85, NORMAL, PHYSICAL,   100, 15,  30
1	move SLASH,        EFFECT_NORMAL_HIT,         70, NORMAL, PHYSICAL,   100, 20,   0
1	move SUPER_FANG,   EFFECT_SUPER_FANG,          1, NORMAL, PHYSICAL,    90, 10,   0
1	move CUT,          EFFECT_NORMAL_HIT,         50, NORMAL, PHYSICAL,    95, 30,   0
1	move STRENGTH,     EFFECT_NORMAL_HIT,         80, NORMAL, PHYSICAL,   100, 15,   0
1	move QUICK_ATTACK, EFFECT_PRIORITY_HIT,       40, NORMAL, PHYSICAL,   100, 30,   0
1	move WRAP,         EFFECT_TRAP_TARGET,        15, NORMAL, PHYSICAL,    90, 20,   0
0	move FURY_ATTACK,  EFFECT_MULTI_HIT,          15, NORMAL, PHYSICAL,    85, 20,   0
0	move FURY_SWIPES,  EFFECT_MULTI_HIT,          18, NORMAL, PHYSICAL,    80, 15,   0
1	move HORN_ATTACK,  EFFECT_NORMAL_HIT,         65, NORMAL, PHYSICAL,   100, 25,   0
1	move STOMP,        EFFECT_STOMP,              65, NORMAL, PHYSICAL,   100, 20,  30
1	move DIZZY_PUNCH,  EFFECT_CONFUSE_HIT,        70, NORMAL, PHYSICAL,   100, 10,  20
1	move HEADBUTT,     EFFECT_FLINCH_HIT,         70, NORMAL, PHYSICAL,   100, 15,  30
1	move EXPLOSION,    EFFECT_SELFDESTRUCT,      250, NORMAL, PHYSICAL,   100,  5,   0
1	move RETURN,       EFFECT_RETURN,              1, NORMAL, PHYSICAL,   100, 20,   0
1	move EXTREMESPEED, EFFECT_PRIORITY_HIT,       80, NORMAL, PHYSICAL,   100,  5,   0
1	move GIGA_IMPACT,  EFFECT_HYPER_BEAM,        150, NORMAL, PHYSICAL,    90,  5,   0
1	move SWIFT,        EFFECT_ALWAYS_HIT,         60, NORMAL, SPECIAL,    100, 20,   0
1	move SONICBOOM,    EFFECT_STATIC_DAMAGE,      20, NORMAL, SPECIAL,     90, 20,   0
1	move TRI_ATTACK,   EFFECT_TRI_ATTACK,         80, NORMAL, SPECIAL,    100, 10,  20
1	move HIDDEN_POWER, EFFECT_HIDDEN_POWER,       60, NORMAL, SPECIAL,    100, 15,   0
1	move HYPER_VOICE,  EFFECT_NORMAL_HIT,         90, NORMAL, SPECIAL,    100, 10,   0
1	move HYPER_BEAM,   EFFECT_HYPER_BEAM,        150, NORMAL, SPECIAL,     90,  5,   0
1	move ATTRACT,      EFFECT_ATTRACT,             0, NORMAL, STATUS,     100, 15,   0
1	move GROWL,        EFFECT_ATTACK_DOWN,         0, NORMAL, STATUS,     100, 40,   0
1	move LEER,         EFFECT_DEFENSE_DOWN,        0, NORMAL, STATUS,     100, 30,   0
1	move DEFENSE_CURL, EFFECT_DEFENSE_CURL,        0, NORMAL, STATUS,     100, 40,   0
1	move DOUBLE_TEAM,  EFFECT_EVASION_UP,          0, NORMAL, STATUS,     100, 15,   0
1	move SCREECH,      EFFECT_DEFENSE_DOWN_2,      0, NORMAL, STATUS,      85, 40,   0
1	move GLARE,        EFFECT_PARALYZE,            0, NORMAL, STATUS,     100, 30,   0
1	move SLEEP_TALK,   EFFECT_SLEEP_TALK,          0, NORMAL, STATUS,     100, 10,   0
1	move SING,         EFFECT_SLEEP,               0, NORMAL, STATUS,      55, 15,   0
1	move SUPERSONIC,   EFFECT_CONFUSE,             0, NORMAL, STATUS,      55, 20,   0
1	move DISABLE,      EFFECT_DISABLE,             0, NORMAL, STATUS,     100, 20,   0
1	move RECOVER,      EFFECT_HEAL,                0, NORMAL, STATUS,     100, 10,   0
1	move ROAR,         EFFECT_FORCE_SWITCH,        0, NORMAL, STATUS,     100, 20,   0
1	move FOCUS_ENERGY, EFFECT_FOCUS_ENERGY,        0, NORMAL, STATUS,     100, 30,   0
1	move SWORDS_DANCE, EFFECT_ATTACK_UP_2,         0, NORMAL, STATUS,     100, 20,   0
1	move TRANSFORM,    EFFECT_TRANSFORM,           0, NORMAL, STATUS,     100, 10,   0
1	move MEAN_LOOK,    EFFECT_MEAN_LOOK,           0, NORMAL, STATUS,     100,  5,   0
1	move SCARY_FACE,   EFFECT_SPEED_DOWN_2,        0, NORMAL, STATUS,     100, 10,   0
1	move SAFEGUARD,    EFFECT_SAFEGUARD,           0, NORMAL, STATUS,     100, 25,   0
1	move BELLY_DRUM,   EFFECT_BELLY_DRUM,          0, NORMAL, STATUS,     100, 10,   0
1	move SWAGGER,      EFFECT_SWAGGER,             0, NORMAL, STATUS,      90, 15, 100
1	move PAIN_SPLIT,   EFFECT_PAIN_SPLIT,          0, NORMAL, STATUS,     100, 20,   0
1	move PERISH_SONG,  EFFECT_PERISH_SONG,         0, NORMAL, STATUS,     100,  5,   0
1	move PROTECT,      EFFECT_PROTECT,             0, NORMAL, STATUS,     100, 10,   0
1	move ENDURE,       EFFECT_ENDURE,              0, NORMAL, STATUS,     100, 10,   0
1	move ENCORE,       EFFECT_ENCORE,              0, NORMAL, STATUS,     100,  5,   0
1	move FORESIGHT,    EFFECT_FORESIGHT,           0, NORMAL, STATUS,     100, 40,   0
1	move SUBSTITUTE,   EFFECT_SUBSTITUTE,          0, NORMAL, STATUS,     100, 10,   0
